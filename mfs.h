...
typedef struct
{
    ...
    DirectoryEntry *dirEntry; // information about directory
    DirectoryEntry *dirTable; // pointer to directory entries
...
void format_time(time_t t, char *s, int len); //utility functions for printing time
